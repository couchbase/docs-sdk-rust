= Couchbase Rust SDK Documentation

This repository hosts the documentation source for the https://docs.couchbase.com/rust-sdk/1.1/hello-world/overview.html[Couchbase Rust SDK].

This branch documents the 1.0 release of the SDK.
It follows the https://docs.couchbase.com/rust-sdk/1.1/project-docs/compatibility.html#api-version[SDK 3.10 API].
...
The philosophy behind the Information Architecture can be found in the https://docs.couchbase.com/rust-sdk/1.0/project-docs/metadoc-about-these-sdk-docs.html[meta doc].
...
| `name_platform:` | Allows us to name the SDK within shared content (*Rust*).

| `name-sdk:` | Allows us to name the SDK within shared content (*Rust SDK*).
...
A value of `3` should not be used, save in exceptionally complicated pages like that shown (the https://docs.couchbase.com/rust-sdk/1.6/project-docs/compatibility.html[compatibility page]).
...
Production branches use the *release/x.y* naming pattern (e.g. `release/1.0`, `release/1.1`).
